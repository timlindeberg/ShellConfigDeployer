...
class ConfigDeployer:
    def __init__(self, server, programs, files, printer):
        ...
        try:
            ssh.connect(server, username=settings.USER, password=settings.PASSWORD, port=settings.PORT)
    ...
    def execute_commands(self, commands):
        ...
        self.printer.verbose('Executing commands on server:')
